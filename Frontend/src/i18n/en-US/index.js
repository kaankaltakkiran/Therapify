...
: `Connect with expert therapists for personalized mental health support with an AI-powered matching system`,
	...
	"Seanslar, güvenli video görüşme platformumuz üzerinden gerçekleştirilir. İnternet bağlantısı olan herhangi bir cihazdan katılabilirsiniz.": `Sessions are conducted via our secure video calling platform. You can join from any device with an internet connection.`,
	...
	"Platformumuza katılarak danışanlarla buluşun ve pratiğinizi genişletin": `Join our platform to meet clients and expand your practice`,
	...
	"Deneyim (Yıl)": `Experience (Years)`,
	"Uzmanlık Alanları": `Areas of Expertise`,
	"Eğitim Bilgileri": `Education Information`,
	"Hakkında": `About`,
	"Seans Ücreti (TL)": `Session Fee (TL)`,
	"Seans Süresi (Dakika)": `Session Duration (Minutes)`,
	"Konuşulan Diller": `Languages spoken`,
	"Online Görüşme Yapıyorum": `I'm in Online Conversation`,
	"Yüz Yüze Görüşme Yapıyorum": `I Meet Face to Face`,
	"Ofis Adresi": `Office Address`,
	"Özgeçmiş (Cv)": `Curriculum Vitae (Cv)`,
	"Diploma": `Diploma`,
	"Lisans Belgesi": `License Certificate`,
